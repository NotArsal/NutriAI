...
class PatientInput(BaseModel):
    ...
    blood_pressure:     int   = Field(..., ge=80,  le=200,  examples=[135],   description="Systolic BP (80-200 mmHg)")
    glucose:            float = Field(..., ge=60,  le=400,  examples=[150.0], description="Fasting plasma glucose (60-400 mg/dL)")
